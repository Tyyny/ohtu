...
class TestKauppa(unittest.TestCase):
    ...
    def test_koriin_lisataan_kaksi_eri_tuotetta_ja_pankin_metodia_tilisiirto_kutsutaan_oikeilla(self):
    ...
    def test_koriin_lisataan_kaksi_samaa_tuotetta_ja_pankin_metodia_tilisiirto_kutsutaan_oikeilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_koriin_lisataan_loppunut_tuote_ja_pankin_metodia_tilisiirto_kutsutaan_oikeilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
